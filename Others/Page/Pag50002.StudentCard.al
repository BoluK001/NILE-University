page 51534366 "Student Card"
{
    Caption = 'Student Card';
    PageType = Card;
    PromotedActionCategories = 'New,Process,Report,New Document,Approve,Request Approval,Prices & Discounts,Navigate,Student';
        ...
        area(content)
        {
            group(General)
            {
                ...
                field("Gender"; "Gender")
                {
                    ApplicationArea = Basic, Suite;
                    Importance = Additional;
                    ToolTip = 'Specifies customers Gender.';
                }
                field("Programme"; "Programme")
                {
                    ApplicationArea = Basic, Suite;
                    Importance = Additional;
                    ToolTip = 'Specifies customers current programme';
                }
            }
            group("Address & Contact")
            {
                ...
                {
                    ApplicationArea = Basic, Suite;
                    Caption = 'University E-Mail';
                    ExtendedDatatype = EMail;
                    Importance = Promoted;
                    ToolTip = 'Specifies the customer''s email address.';
                }
                field("Other E-Mail"; "Other E-Mail")
                {
                    ApplicationArea = Basic, suite;
                    ExtendedDatatype = EMail;
                    ToolTip = 'Specifies the customer''s other email address.';
                }
    ...
    actions
    {
        ...
        area(reporting)
        {
            ...
            Action("Student Amortization List")
            {
                ApplicationArea = Basic, Suite;
                Caption = 'Semeter Details';
                Image = "History";
                PromotedCategory = Category8;
                Promoted = true;
                ToolTip = 'View Students Semester';
                RunObject = Page "Student Amortization List";
