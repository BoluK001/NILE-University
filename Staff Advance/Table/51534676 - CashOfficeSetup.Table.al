table 51534676 "Cash Office Setup"
{
    ...
    fields
    {
        ...
        field(51534988; "Use Central Payment System"; Boolean)
        {
        }
        ...
        field(50062; "Store Requisition Nos"; Code[20])
        {
            TableRelation = "No. Series";
        }
        field(50063; "Fuel Requisition Nos"; Code[20])
        {
            TableRelation = "No. Series";
        }
        field(50064; "InterBank Transfer Limit"; Decimal)
        {
        }
        field(50065; "Funds Doc No."; Code[20])
        {
            TableRelation = "No. Series";
        }
        field(50066; "Imprest Doc. No."; Code[20])
        {
            TableRelation = "No. Series";
        }
        field(50067; "Batch Payment Voucher Nos"; Code[20])
        {
            TableRelation = "No. Series";
        }
        field(50068; "PFA Transfer Nos"; Code[20])
        {
            TableRelation = "No. Series";
        }
        field(50070; "Cust Upload Nos"; Code[20])
        {
            TableRelation = "No. Series";
        }
        field(50071; "Match Lodgment Nos"; Code[20])
        {
            TableRelation = "No. Series";
        }
        field(50072; "Master Lodgement Nos"; Code[20])
        {
            TableRelation = "No. Series";
        }
        field(50073; "Contribution Upload Nos"; Code[20])
        {
            TableRelation = "No. Series";
        }
        field(50074; "Allocation Upload Nos"; Code[20])
        {
            TableRelation = "No. Series";
        }
        field(50075; "Payout Transactions Nos"; Code[20])
        {
            TableRelation = "No. Series";
        }
        field(50076; "Refund Transactions Nos"; Code[20])
        {
            TableRelation = "No. Series";
        }
        field(50077; "Micro Pension Lodgement"; Code[20])
        {
            TableRelation = "No. Series";
        }
        field(50078; "MultiFund Movement"; Code[20])
        {
            TableRelation = "No. Series";
        }
    }
