page 51534651 "Approved Staff Claims"
{
    CardPageID = "Staff Claim";
    DeleteAllowed = false;
    Editable = false;
    PageType = List;
    AdditionalSearchTerms = 'Approved Staff Claims';
                            ...
                            repeat
                                ...
                                if StfLines.FindFirst then
                                    repeat
                                        ...
                                        // PaymentsLines."Payment Narration" := StfLines."Claim Narration";
