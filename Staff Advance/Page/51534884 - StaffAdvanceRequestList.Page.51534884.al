page 51534884 "Staff Advance Request List."
{
            ...
            group("&Functions")
            {
                            ...
                            repeat
                                ...
                                if AdvLines.FindFirst then
                                    repeat
                                        ...
                                        PaymentsLines."Account Type" := AdvLines."Account Type";
                                        PaymentsLines."Account No." := AdvLines."Account No.";
                                        PaymentsLines."Account Name" := AdvLines."Account Name";
                                        // PaymentsLines."Transaction Name" := AdvLines.Purpose;
                                        PaymentsLines."Narration" := AdvLines."Advance Narration";
                                        PaymentsLines.Amount := AdvLines.Amount;
                                        ...
                                        PaymentsLines."Shortcut Dimension 1 Code" := AdvHeader."Shortcut Dimension 1 Code";
                                        PaymentsLines.Validate("shortcut Dimension 1 Code");
                                        PaymentsLines."Shortcut Dimension 2 Code" := AdvHeader."Shortcut Dimension 2 Code";
                                        PaymentsLines.Validate("Shortcut Dimension 2 Code");
                                        //PaymentsLines."Staff Advance No." := AdvHeader."No.";
                ...
                action("Send A&pproval Request")
                {
                    ...
                    begin
                        ...
                        // if ApprovalsMgmt.CheckStaffAdvanceApprovalPossible(Rec) then
                        //   ApprovalsMgmt.OnSendStaffAdvanceForApproval(Rec);
                    end;
                }
                action("Cancel Approval Re&quest")
                {
                    ...
                    begin
                        // IF ApprovalMgt.CancelAdvanceApprovalRequest(Rec,TRUE,TRUE) THEN;
                        // ApprovalsMgmt.OnCancelStaffAdvanceForApproval(Rec);
