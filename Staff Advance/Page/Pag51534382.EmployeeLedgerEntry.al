page 51534382 "Apply Employee Entries2"
{
    ...
    var
        ...
        ApplyEmployeeLedgerEntry: Record "Employee Ledger Entry";
        AdvanSurrender: Record "Staff Advanc Surrender Details";
        EmployeeLedgerEntry: Record "Employee Ledger Entry";
        EmployLine: Record "Staff Advanc Surrender Details";
        AdvanSurrenderHeader: Record "Staff Advance Surrender Header";
    ...
    begin
        case CalcType of
            ...
            //added Advance surrender line
            CalcType::PV:
                begin
                    ApplyEmployeeLedgerEntry."Posting Date" := AdvanSurrender."Surrender Date";
                    ApplyEmployeeLedgerEntry."Document Type" := ApplyEmployeeLedgerEntry."Document Type"::Payment;
                    ApplyEmployeeLedgerEntry."Document No." := AdvanSurrender."Surrender Doc No.";
                    ApplyEmployeeLedgerEntry."Employee No." := AdvanSurrender."Account No.";
                    ApplyEmployeeLedgerEntry.Description := AdvanSurrender."Account Name";
                    ApplyEmployeeLedgerEntry."Currency Code" := AdvanSurrender."Currency Code";
                    ApplyEmployeeLedgerEntry.Amount := AdvanSurrender.Amount;
                    ApplyEmployeeLedgerEntry."Remaining Amount" := -AdvanSurrender.Amount;
                    CalcApplnAmount;
                end;
        end;
    end;
                        ...
                        ApplnType::"Applies-to ID":
                            begin
                                with EmployeeLedgerEntry do begin
                                    AppliedEmplLedgEntry.SetCurrentKey("Employee No.", Open, Positive);
                                    AppliedEmplLedgEntry.SetRange("Employee No.", AdvanSurrender."Account No.");
                                    AppliedEmplLedgEntry.SetRange(Open, true);
                                    AppliedEmplLedgEntry.SetRange("Applies-to ID", AdvanSurrender."Applies-to ID");
    ...
    procedure SetPVLine(NewAdvancSurrLine: Record "Staff Advanc Surrender Details"; var NewEmployeeLedgEntry: Record "Employee Ledger Entry"; ApplnTypeSelect: Integer)
    var
        PaymentHeader: Record "Voucher Header";
    begin
        EmployLine := NewAdvancSurrLine;
        Rec.CopyFilters(NewEmployeeLedgEntry);

        ApplyingAmount := EmployLine.Amount;

        AdvanSurrenderHeader.Reset;
        AdvanSurrenderHeader.SetRange(AdvanSurrenderHeader."No.", NewAdvancSurrLine."Surrender Doc No.");

        if AdvanSurrenderHeader.Find('-') then begin
            ApplnDate := AdvanSurrenderHeader."Surrender Posting Date";
            ApplnCurrencyCode := AdvanSurrenderHeader."Currency Code";
            CalcType := CalcType::PV;
        end;

        case ApplnTypeSelect of
            NewAdvancSurrLine.FieldNo("Applies-to Doc. No."):
                ApplnType := ApplnType::"Applies-to Doc. No.";
            NewAdvancSurrLine.FieldNo("Applies-to ID"):
                ApplnType := ApplnType::"Applies-to ID";
        end;
