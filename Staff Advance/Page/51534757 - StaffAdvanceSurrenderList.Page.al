page 51534757 "Staff Advance Surrender List"
{
    Caption = 'Work Advance Retire List';
    CardPageID = "Staff Advance Accounting";
    PageType = List;
    SourceTable = "Staff Advance Surrender Header";
    PromotedActionCategories = 'New,Process,Reports,Approvals,Budget Controls';
            ...
            group(Functions)
            {
                ...
                action(Approvals)
                {
                    ...
                    begin
                        ...
                        WorkflowsEntriesBuffer.RunWorkflowEntriesPage(Rec.RecordId, DATABASE::"Staff Advance Surrender Header", DocType.AsInteger(), Rec."No.");
                    end;
                }
