...
//         {
//             Caption = 'Document No.';
//             TableRelation = "Req. Header"."No." WHERE("Document Type" = FIELD("Document Type"));
//         }
...
//             trigger OnValidate()
//             var
//                 TempPurchLine: Record "Req. Line" temporary;
//             begin
//                 GetReqHeader;
//                 TestStatusOpen;
...
//                           xRec.GetDeferralAmount(), ReqHeader."Posting Date", '', xRec."Currency Code", true);
//                 end;
//                 TempPurchLine := Rec;
//                 Init;
...
//                 //OnBeforeAssignHeaderValues(Rec, ReqHeader);

//                 GetReqHeader;
//                 InitHeaderDefaults(ReqHeader, TempPurchLine);
//                 UpdateLeadTimeFields;
//                 UpdateDates;

//                 //OnAfterAssignHeaderValues(Rec, ReqHeader);
...
//                // OnAfterAssignFieldsForNo(Rec, xRec, ReqHeader);
...
//                 GetReqHeader();
//                 GetPriceCalculationHandler(ReqHeader, PriceCalculation);
...
//                           "Unit Cost (LCY)", ReqHeader."Currency Factor"),
...
//                         begin
//                             "VAT Base Amount" :=
//                               Round(Amount * (1 - ReqHeader."VAT Base Discount %" / 100), Currency."Amount Rounding Precision");
...
//                         begin
//                             ReqHeader.TestField("VAT Base Discount %", 0);
...
//                                       "Tax Area Code", "Tax Group Code", "Tax Liable", ReqHeader."Posting Date",
//                                       "VAT Base Amount", "Quantity (Base)", ReqHeader."Currency Factor"),
//                                     Currency."Amount Rounding Precision");
//                                 // OnAfterSalesTaxCalculate(Rec, ReqHeader, Currency);
...
//                               Round(
//                                 "Amount Including VAT" /
//                                 (1 + (1 - ReqHeader."VAT Base Discount %" / 100) * "VAT %" / 100),
//                                 Currency."Amount Rounding Precision");
//                             "VAT Base Amount" :=
//                               Round(Amount * (1 - ReqHeader."VAT Base Discount %" / 100), Currency."Amount Rounding Precision");
//                         end;
...
//                                       "Tax Area Code", "Tax Group Code", "Tax Liable", ReqHeader."Posting Date",
//                                       "Amount Including VAT", "Quantity (Base)", ReqHeader."Currency Factor"),
//                                     Currency."Amount Rounding Precision");
//                                 // OnAfterSalesTaxCalculateReverse(Rec, ReqHeader, Currency);
//                                 "VAT Base Amount" := Amount;
//                                 if "VAT Base Amount" <> 0 then
//                                     "VAT %" :=
//                                       Round(100 * ("Amount Including VAT" - "VAT Base Amount") / "VAT Base Amount", 0.00001)
...
//                           GetDate, "Currency Code",
//                           "Outstanding Amount", ReqHeader."Currency Factor"),
...
//                         CurrExchRate.ExchangeAmtFCYToLCY(
//                           GetDate, "Currency Code",
//                           "Amt. Rcd. Not Invoiced", ReqHeader."Currency Factor"),
//                         Currency2."Amount Rounding Precision")
//                 else
//                     "Amt. Rcd. Not Invoiced (LCY)" :=
...
//             trigger OnValidate()
//             begin
//                 if ReqHeader."Send IC Document" and
...
//             Editable = false;
//             TableRelation = "Req. Line"."Line No." WHERE("Document Type" = FIELD("Document Type"),
...
//                 if ReqHeader."Prices Including VAT" and (Type in [Type::Item, Type::Resource]) then
//                     Validate("Direct Unit Cost",
//                       Round(
...
//             // TableRelation = "Req. Header"."No." WHERE("Document Type" = CONST("Blanket Order"));
...
//             // TableRelation = "Req. Line"."Line No." WHERE("Document Type" = CONST("Blanket Order"),
...
//                                 ItemCrossReference.SetFilter("Cross-Reference Type No.", '%1|%2', ReqHeader."Buy-from Vendor No.", '');
...
//                                 ItemVendorCatalog.SetRange("Vendor No.", ReqHeader."Buy-from Vendor No.");
...
//                     TestField(Type, Type::"G/L Account");
//                     GetReqHeader;
//                     ReqHeader.TestField("Buy-from IC Partner Code", '');
//                     ReqHeader.TestField("Pay-to IC Partner Code", '');
...
//                                 ItemReference.SetFilter("Reference Type No.", '%1|%2', ReqHeader."Buy-from Vendor No.", '');
...
//             begin
//                 GetReqHeader;
//                 DeferralPostDate := GetDeferralPostDate(ReqHeader);
...
//                   Description, ReqHeader."Currency Code");

//                 if "Document Type" = "Document Type"::"Return Order" then
//                     "Returns Deferral Start Date" :=
//                       DeferralUtilities.GetDeferralStartDate(
//                           "Deferral Document Type"::Purchase.AsInteger(),
//                           "Document Type".AsInteger(), "Document No.", "Line No.", "Deferral Code", ReqHeader."Posting Date");
//             end;
//         }
...
//                     GetReqHeader;
//                     if ReqHeader."Language Code" <> '' then begin
//                         UnitOfMeasureTranslation.SetRange(Code, "Unit of Measure Code");
//                         UnitOfMeasureTranslation.SetRange("Language Code", ReqHeader."Language Code");
...
//             begin
//                 GetReqHeader;
//                 "Buy-from Vendor No." := ReqHeader."Buy-from Vendor No.";
...
//             begin
//                 GetReqHeader();
//                 // ItemReferenceMgt.PurchaseReferenceNoLookUp(Rec, ReqHeader);
//             end;
...
//                 GetReqHeader();
//                 "Buy-from Vendor No." := ReqHeader."Buy-from Vendor No.";
//                 // ItemReferenceMgt.ValidatePurchaseReferenceNo(Rec, ReqHeader, ItemReference, true, CurrFieldNo);
//             end;
//         }
...
//                         CurrExchRate.ExchangeAmtFCYToLCY(
//                           GetDate, "Currency Code",
//                           "Return Shpd. Not Invd.", ReqHeader."Currency Factor"),
//                         Currency2."Amount Rounding Precision")
//                 else
//                     "Return Shpd. Not Invd. (LCY)" :=
...
//                 PurchaseHeader: Record "Req. Header";
...
//                 PurchaseHeader.TestField("Document Type", ReqHeader."Document Type"::Requisition);
//                 PurchaseHeader.TestField(Status, ReqHeader.Status::Released);
//                 TestField(Type, Type::Item);
//                 TestField("No.");
...
//         ReqHeader: Record "Req. Header";
//         PurchLine2: Record "Req. Line";
...
//         //OnAfterInitOutstandingAmount(Rec, xRec, ReqHeader, Currency);
//     end;
...
//         CalcInvDiscToInvoice;
//     //     if ReqHeader."Document Type" <> ReqHeader."Document Type"::Invoice then
//     //         CalcPrepaymentToDeduct;

//     //     OnAfterInitQtyToInvoice(Rec, CurrFieldNo);
//  end;

//     local procedure InitOutstandingAndQtyToShipReceive(var TempPurchLine: Record "Req. Line" temporary)
//     var
//         IsHandled: Boolean;
//     begin
//         IsHandled := false;
...
//     local procedure InitHeaderDefaults(ReqHeader: Record "Req. Header"; var TempPurchLine: Record "Req. Line" temporary)
//     begin
//         CheckBuyFromVendorNo(ReqHeader);

//         "Buy-from Vendor No." := ReqHeader."Buy-from Vendor No.";
//         "Currency Code" := ReqHeader."Currency Code";
//         "Expected Receipt Date" := ReqHeader."Expected Receipt Date";
...
//         "Transaction Type" := ReqHeader."Transaction Type";
//         "Transport Method" := ReqHeader."Transport Method";
//         "Pay-to Vendor No." := ReqHeader."Pay-to Vendor No.";
//         "Price Calculation Method" := ReqHeader."Price Calculation Method";
//         "Gen. Bus. Posting Group" := ReqHeader."Gen. Bus. Posting Group";
//         "VAT Bus. Posting Group" := ReqHeader."VAT Bus. Posting Group";
//         "Entry Point" := ReqHeader."Entry Point";
//         Area := ReqHeader.Area;
//         "Transaction Specification" := ReqHeader."Transaction Specification";
//         "Tax Area Code" := ReqHeader."Tax Area Code";
//         "Tax Liable" := ReqHeader."Tax Liable";
//         if not "System-Created Entry" and ("Document Type" = "Document Type"::Order) and HasTypeToFillMandatoryFields or
//            IsServiceCharge
//         then
//             "Prepayment %" := ReqHeader."Prepayment %";
//         "Prepayment Tax Area Code" := ReqHeader."Tax Area Code";
//         "Prepayment Tax Liable" := ReqHeader."Tax Liable";
//         "Responsibility Center" := ReqHeader."Responsibility Center";
//         "Requested Receipt Date" := ReqHeader."Requested Receipt Date";
//         "Promised Receipt Date" := ReqHeader."Promised Receipt Date";
//         "Inbound Whse. Handling Time" := ReqHeader."Inbound Whse. Handling Time";
//         "Order Date" := ReqHeader."Order Date";

//         //OnAfterInitHeaderDefaults(Rec, ReqHeader, TempPurchLine);
//     end;
...
//         "Allow Item Charge Assignment" := true;
//         //PrepaymentMgt.SetPurchPrepaymentPct(Rec, ReqHeader."Posting Date");
//         if IsInventoriableItem then
//             PostingSetupMgt.CheckInvtPostingSetupInventoryAccount("Location Code", "Posting Group");
...
//         if ReqHeader."Language Code" <> '' then
//             GetItemTranslation;
...
//     procedure SetReqHeader(NewReqHeader: Record "Req. Header")
//     begin
...
//     begin
//         GetReqHeader(ReqHeader, Currency);
//     end;

//     procedure GetReqHeader(var OutReqHeader: Record "Req. Header"; OutCurrency: Record Currency)
//     var
//         IsHandled: Boolean;
//     begin
//         IsHandled := false;
//         // OnBeforeGetReqHeader(Rec, ReqHeader, IsHandled, Currency);
//         if IsHandled then
//             exit;

//         TestField("Document No.");
//         if ("Document Type" <> ReqHeader."Document Type") or ("Document No." <> ReqHeader."No.") then begin
//             ReqHeader.Get("Document Type", "Document No.");
//             if ReqHeader."Currency Code" = '' then
//                 Currency.InitRoundingPrecision
//             else begin
//                 ReqHeader.TestField("Currency Factor");
...
//         // OnAfterGetReqHeader(Rec, ReqHeader, Currency);
//         OutReqHeader := ReqHeader;
...
//     begin
//         ReservEntry.SetSource(DATABASE::"Req. Line", "Document Type".AsInteger(), "Document No.", "Line No.", '', 0);
...
//     begin
//         ReservEntry.SetSourceFilter(DATABASE::"Req. Line", "Document Type".AsInteger(), "Document No.", "Line No.", false);
...
//             exit(0);
//         GetReqHeader();
//         if not ReqHeader."Prices Including VAT" then
//             exit("Line Amount");
...
//             exit(0);
//         GetReqHeader();
//         if ReqHeader."Prices Including VAT" then
//             exit("Line Amount");
...
//                     GetReqHeader;
//                     IsHandled := false;
//                     //OnUpdateDirectUnitCostOnBeforeFindPrice(ReqHeader, Rec, CalledByFieldNo, CurrFieldNo, IsHandled);
//                     if not IsHandled then begin
//                         GetPriceCalculationHandler(ReqHeader, PriceCalculation);
...
//     procedure GetPriceCalculationHandler(PurchaseHeader: Record "Req. Header"; var PriceCalculation: Interface "Price Calculation")
//     var
...
//         // OnUpdateUnitCostOnBeforeUpdateUnitCostLCY(Rec, xRec, ReqHeader, CurrFieldNo, Item, SKU, Currency, GLSetup);
...
//               CurrExchRate.ExchangeAmtFCYToLCY(
//                 GetDate, "Currency Code",
//                 "Unit Cost", ReqHeader."Currency Factor");
//         end else
...
//         // OnAfterUpdateUnitCost(Rec, xRec, ReqHeader, Item, SKU, Currency, GLSetup);
...
//                             "VAT Base Amount" :=
//                               Round(
//                                 Amount * (1 - ReqHeader."VAT Base Discount %" / 100),
//                                 Currency."Amount Rounding Precision");
//                             "Amount Including VAT" :=
//                               TotalLineAmount + "Line Amount" -
//                               Round(
//                                 (TotalAmount + Amount) * (ReqHeader."VAT Base Discount %" / 100) * "VAT %" / 100,
//                                 Currency."Amount Rounding Precision", Currency.VATRoundingDirection) -
//                               TotalAmountInclVAT - TotalInvDiscAmount - "Inv. Discount Amount";
//                             // OnUpdateVATAmountsOnAfterCalcNormalVATAmountsForPricesIncludingVAT(Rec, ReqHeader, Currency, TotalAmount, TotalAmountInclVAT);
//                         end;
//                     "VAT Calculation Type"::"Full VAT":
//                         begin
//                             Amount := 0;
...
//                               TotalAmount + Amount +
//                               Round(
//                                 (TotalAmount + Amount) * (1 - ReqHeader."VAT Base Discount %" / 100) * "VAT %" / 100,
//                                 Currency."Amount Rounding Precision", Currency.VATRoundingDirection) -
//                               TotalAmountInclVAT;
//                         end;
//                     "VAT Calculation Type"::"Full VAT":
...
//             "Unit Cost" :=
//               CurrExchRate.ExchangeAmtLCYToFCY(
//                 GetDate, ReqHeader."Currency Code",
//                 "Unit Cost (LCY)", ReqHeader."Currency Factor")
//         else
...
//     var
//         Item: Record Item;
//         PurchLine: Record "Req. Line";
//         LastPurchLine: Record "Req. Line";
...
//     local procedure InitNewLine(var NewPurchLine: Record "Req. Line")
//     var
//         PurchLine: Record "Req. Line";
//     begin
...
//     begin
//         GetReqHeader;
//         if ReqHeader."Posting Date" <> 0D then
//             exit(ReqHeader."Posting Date");
//         exit(WorkDate);
//     end;
...
//             "Shortcut Dimension 1 Code", "Shortcut Dimension 2 Code", ReqHeader."Dimension Set ID", DATABASE::Vendor);
//         DimMgt.UpdateGlobalDimFromDimSetID("Dimension Set ID", "Shortcut Dimension 1 Code", "Shortcut Dimension 2 Code");
...
//            (not ReqHeader."Prices Including VAT")
//         then
...
//     begin
//         GetReqHeader;
//         OnBeforeTestStatusOpen(Rec, ReqHeader);
...
//         OnAfterTestStatusOpen(Rec, ReqHeader);
//     end;
...
//                 "Lead Time Calculation" := ReqHeader."Lead Time Calculation";
...
//     begin
//         GetReqHeader;
//         if ReqHeader."Expected Receipt Date" <> 0D then
//             Validate("Expected Receipt Date", ReqHeader."Expected Receipt Date")
//         else
//             Validate("Order Date", ReqHeader."Order Date");
//     end;
...
//     procedure UpdateVATOnLines(QtyType: Option General,Invoicing,Shipping; var ReqHeader: Record "Req. Header"; var PurchLine: Record "Req. Line"; var VATAmountLine: Record "VAT Amount Line") LineWasModified: Boolean
//     var
...
//         IsHandled := false;
//         OnUpdateVATOnLinesOnBeforeProcessPurchLines(Rec, xRec, ReqHeader, VATAmountLine, TempVATAmountLineRemainder, LineWasModified, IsHandled, QtyType);
//         if IsHandled then
//             exit(LineWasModified);

//         with PurchLine do begin
//             SetRange("Document Type", ReqHeader."Document Type");
//             SetRange("Document No.", ReqHeader."No.");
//             OnUpdateVATOnLinesOnAfterSetFilters(PurchLine, ReqHeader);
//             LockTable();
//             if FindSet then
//                 repeat
//                     if not ZeroAmountLine(QtyType) and
//                        ((ReqHeader."Document Type" <> ReqHeader."Document Type"::Invoice) or ("Prepmt. Amt. Inv." = 0))
//                     then begin
...
//                             OnUpdateVATOnLinesOnBeforeCalculateAmounts(PurchLine, ReqHeader);
//                             if QtyType = QtyType::General then begin
//                                 if ReqHeader."Prices Including VAT" then begin
...
//                                     NewVATBaseAmount :=
//                                       Round(
//                                         NewAmount * (1 - ReqHeader."VAT Base Discount %" / 100),
//                                         Currency."Amount Rounding Precision");
//                                 end else begin
...
//                                     Rec, ReqHeader, VATAmountLine, TempVATAmountLineRemainder, NewAmountIncludingVAT, VATAmount,
...
//                                     Rec, ReqHeader, VATAmountLine, TempVATAmountLineRemainder, QtyType);
//                             end;
//                             OnUpdateVATOnLinesOnAfterCalculateAmounts(PurchLine, ReqHeader);
...
//         OnAfterUpdateVATOnLines(ReqHeader, PurchLine, VATAmountLine, QtyType);
//     end;

//     procedure CalcVATAmountLines(QtyType: Option General,Invoicing,Shipping; var ReqHeader: Record "Req. Header"; var PurchLine: Record "Req. Line"; var VATAmountLine: Record "VAT Amount Line")
//     var
...
//     begin
//         if IsCalcVATAmountLinesHandled(ReqHeader, PurchLine, VATAmountLine, QtyType) then
//             exit;

//         Currency.Initialize(ReqHeader."Currency Code");
...
//             SetRange("Document Type", ReqHeader."Document Type");
//             SetRange("Document No.", ReqHeader."No.");
//             OnCalcVATAmountLinesOnAfterSetFilters(PurchLine, ReqHeader);
//             if FindSet then
//                 repeat
//                     if not ZeroAmountLine(QtyType) then begin
//                         if (Type = Type::"G/L Account") and not "Prepayment Line" then
//                             RoundingLineInserted := (("No." = GetVPGInvRoundAcc(ReqHeader)) and "System-Created Entry") or RoundingLineInserted;
...
//                                       (not ReqHeader.Receive) and ReqHeader.Invoice and (not "Prepayment Line"):
...
//                                             end;
//                                         IsCreditDocType and (not ReqHeader.Ship) and ReqHeader.Invoice:
...
//                                     OnCalcVATAmountLinesOnBeforeVATAmountLineSumLine(Rec, VATAmountLine, QtyType);
//                                     if ReqHeader."Invoice Discount Calculation" <> ReqHeader."Invoice Discount Calculation"::Amount then
//                                         VATAmountLine.SumLine(
...
//                         OnCalcVATAmountLinesOnAfterCalcLineTotals(VATAmountLine, ReqHeader, PurchLine, Currency, QtyType, TotalVATAmount);
//                     end;
//                 until Next() = 0;
//         end;

//         VATAmountLine.UpdateLines(
//           TotalVATAmount, Currency, ReqHeader."Currency Factor", ReqHeader."Prices Including VAT",
//           ReqHeader."VAT Base Discount %", ReqHeader."Tax Area Code", ReqHeader."Tax Liable", ReqHeader."Posting Date");
...
//         OnAfterCalcVATAmountLines(ReqHeader, PurchLine, VATAmountLine, QtyType);
//     end;

//     procedure GetVATAmountLineOfMaxAmt(var VATAmountLine: Record "VAT Amount Line"; PurchaseLine: Record "Req. Line"): Boolean
//     var
//         VATAmount1: Decimal;
//         VATAmount2: Decimal;
//         IsPositive1: Boolean;
...
//         GetReqHeader;
//         OnAfterUpdateWithWarehouseReceive(ReqHeader, Rec);
...
//                      DATABASE::"Req. Line", "Document Type".AsInteger(), "Document No.", "Line No.", 0, Quantity)
//                 then
//                     ShowDialog := ShowDialog::Error
//                 else
...
//         exit(
//           CurrExchRate.ExchangeAmtLCYToFCY(
//             GetDate, "Currency Code", "Overhead Rate" * QtyPerUOM, ReqHeader."Currency Factor"));
//     end;
...
//         GetReqHeader;
//         if ItemTranslation.Get("No.", "Variant Code", ReqHeader."Language Code") then begin
//             Description := ItemTranslation.Description;
//             "Description 2" := ItemTranslation."Description 2";
//             OnAfterGetItemTranslation(Rec, ReqHeader, ItemTranslation);
//         end;
//     end;
...
//                 DATABASE::"Req. Line", "Document Type".AsInteger(), "Document No.", '', 0, "Line No."));
//     end;
...
//                 OnCrossReferenceNoLookupOnBeforeValidateDirectUnitCost(ReqHeader, Rec);
//                 Validate("Direct Unit Cost");
//             end;
//         end;
//     end;
...
//         TempJobJnlLine.Validate("Posting Date", ReqHeader."Posting Date");
...
//         PurchOrderLine: Record "Req. Line";
//         PurchOrderHeader: Record "Req. Header";
//         IsHandled: Boolean;
//     begin
//         IsHandled := false;
//         OnBeforeUpdatePrepmtAmounts(Rec, ReqHeader, IsHandled);
//         if IsHandled then
//             exit;
...
//         GetReqHeader;
//         ReqHeader.TestField("Prices Including VAT", PurchOrderHeader."Prices Including VAT");
//         if ReqHeader."Prices Including VAT" then begin
...
//     procedure GetVPGInvRoundAcc(var ReqHeader: Record "Req. Header") AccountNo: Code[20]
//     var
...
//     begin
//         IsHandled := false;
//         OnBeforeGetVPGInvRoundAcc(ReqHeader, Vendor, AccountNo, IsHandled);
//         if IsHandled then
//             exit(AccountNo);

//         GetPurchSetup;
//         if PurchSetup."Invoice Rounding" then
//             if Vendor.Get(ReqHeader."Pay-to Vendor No.") then
...
//         GetReqHeader;
//         VendorPostingGroup.Get(ReqHeader."Vendor Posting Group");
...
//     begin
//         IsHandled := false;
//         OnBeforeInitType(Rec, xRec, ReqHeader, IsHandled);
//         if IsHandled then
//             exit;

//         if "Document No." <> '' then begin
//             if not ReqHeader.Get("Document Type", "Document No.") then
//                 exit;
//             if (ReqHeader.Status = ReqHeader.Status::Released) and
...
//     begin
//         if ReqHeader."Send IC Document" and
//            (ReqHeader."IC Direction" = ReqHeader."IC Direction"::Outgoing)
//         then
//             case Type of
...
//                 Type::Item:
//                     begin
//                         ICPartner.Get(ReqHeader."Buy-from IC Partner Code");
...
//                     end;
//             end;
//         OnAfterUpdateICPartner(Rec, ReqHeader);
//     end;
...
//     local procedure GetDeferralPostDate(PurchaseHeader: Record "Req. Header") DeferralPostDate: Date
//     begin
...
//     begin
//         GetReqHeader;
//         DeferralPostDate := ReqHeader."Posting Date";
//         AdjustStartDate := true;
//         if "Document Type" = "Document Type"::"Return Order" then begin
//             if "Returns Deferral Start Date" = 0D then
//                 "Returns Deferral Start Date" := ReqHeader."Posting Date";
...
//             "Deferral Code", "Deferral Document Type"::Purchase.AsInteger(), '', '',
//             "Document Type".AsInteger(), "Document No.", "Line No.",
//             GetDeferralAmount(), DeferralPostDate, Description, ReqHeader."Currency Code", AdjustStartDate);
//     end;
...
//     begin
//         GetReqHeader;
//         if not IncomingDocument.Get(ReqHeader."Incoming Document Entry No.") then
//             exit(false);
...
//             NotificationToSend.Id := ReqHeader.GetLineInvoiceDiscountResetNotificationId;
...
//     begin
//         if ReqHeader."Document Type" <> ReqHeader."Document Type"::Invoice then begin
...
//     begin
//         IsHandled := false;
//         OnBeforeCheckPrepmtAmounts(Rec, ReqHeader, CurrFieldNo, IsHandled);
//         if IsHandled then
//             exit;
...
//     local procedure IsCalcVATAmountLinesHandled(ReqHeader: Record "Req. Header"; var PurchLine: Record "Req. Line"; var VATAmountLine: Record "VAT Amount Line"; QtyType: Option General,Invoicing,Shipping) IsHandled: Boolean
//     begin
//         IsHandled := false;
//         OnBeforeCalcVATAmountLines(ReqHeader, PurchLine, VATAmountLine, IsHandled, QtyType);
//         exit(IsHandled);
//     end;
...
//     local procedure CheckBuyFromVendorNo(PurchaseHeader: Record "Req. Header")
//     var
//         IsHandled: Boolean;
//     begin
//         IsHandled := false;
...
//     var
//         RelatedPurchLine: Record "Req. Line";
//     begin
