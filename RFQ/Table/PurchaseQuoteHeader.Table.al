table 51534351 "Purchase Quote Header"
{
    Caption = 'Purchase Header';
    //LookupPageID = 39006069; Dennis
    ...
    fields
    {
        ...
        field(21; "Expected Closing Date"; DateTime)
        {
            ...
            // trigger OnValidate()
            // begin
            //     if "Expected Closing Date"  Today then
            //     Error('cannot ');
            // end;
        }
        ...
        FIELD(5805; "Quote Vendor Name"; Text[100])
        {
        ...
        field(39004243; "PRF No"; Code[20])
        {
            ...
            begin
                ...
                PurchHeader.SETRANGE(PurchHeader."Purchase Type", PurchHeader."Purchase Type"::Requisition);
        ...
        {
            //TableRelation = "Store Requisition Header";
        }
        ...
        field(50001; "Requester ID"; Boolean)
        {

        }

        field(50002; "Requester Name"; Boolean)
        {
    ...
    begin
        ...
        DocumentSendingProfile.SendVendorRecords(ReportSelections.Usage.AsInteger(), Rec, DocTxt, '', "No.",
          0, FieldNo("No."));
