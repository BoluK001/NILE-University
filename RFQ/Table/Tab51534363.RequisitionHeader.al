...
//     fields
//     {
//         field(1; "Document Type"; Enum "Purchase Type")
//         {
...
//             trigger OnValidate()
//             begin
//                 if ("Document Type" in ["Document Type"::Quote, "Document Type"::Requisition]) and
...
//                 ApprovalEntry.SetRange("Table ID", DATABASE::"Req. Header");
...
//         {
//             CalcFormula = Exist("Req. Line" WHERE("Document Type" = FIELD("Document Type"),
...
//             AutoFormatType = 1;
//             CalcFormula = Sum("Req. Line".Amount WHERE("Document Type" = FIELD("Document Type"),
//                                                             "Document No." = FIELD("No.")));
//             Caption = 'Amount';
//             Editable = false;
//             FieldClass = FlowField;
...
//             AutoFormatExpression = "Currency Code";
//             AutoFormatType = 1;
//             CalcFormula = Sum("Req. Line"."Amount Including VAT" WHERE("Document Type" = FIELD("Document Type"),
//                                                                             "Document No." = FIELD("No.")));
...
//         {
//             CalcFormula = Sum("Req. Line"."A. Rcd. Not Inv. Ex. VAT (LCY)" WHERE("Document Type" = FIELD("Document Type"),
//                                                                                       "Document No." = FIELD("No.")));
...
//         {
//             CalcFormula = Sum("Req. Line"."Amt. Rcd. Not Invoiced (LCY)" WHERE("Document Type" = FIELD("Document Type"),
//                                                                                     "Document No." = FIELD("No.")));
...
//         {
//             AutoFormatType = 1;
//             CalcFormula = Sum("Req. Line"."Inv. Discount Amount" WHERE("Document No." = FIELD("No."),
...
//         {
//             CalcFormula = Min("Req. Line"."Completely Received" WHERE("Document Type" = FIELD("Document Type"),
//                                                                            "Document No." = FIELD("No."),
//                                                                            Type = FILTER(<> " "),
//                                                                            "Location Code" = FIELD("Location Filter")));
...
//         // WhseRequest.SetRange("Source Type", DATABASE::"Req. Line");
...
//         PurchLine: Record "Req. Line";
//         xPurchLine: Record "Req. Line";
//         VendLedgEntry: Record "Vendor Ledger Entry";
//         Vend: Record Vendor;
//         PaymentTerms: Record "Payment Terms";
//         PaymentMethod: Record "Payment Method";
//         CurrExchRate: Record "Currency Exchange Rate";
//         PurchHeader: Record "Req. Header";
...
//         "Doc. No. Occurrence" :=
//             ArchiveManagement.GetNextOccurrenceNo(DATABASE::"Req. Header", "Document Type".AsInteger(), "No.");
...
//     procedure AssistEdit(OldPurchHeader: Record "Req. Header"): Boolean
//     var
//         IsHandled: Boolean;
//     begin
//         IsHandled := false;
...
//         // PostPurchDelete.InitDeleteHeader(Rec, PurchRcptHeader, PurchInvHeader, PurchCrMemoHeader,
...
//     local procedure RecreatePurchLinesFillItemChargeAssignment(PurchLine: Record "Req. Line"; var TempPurchLine: Record "Req. Line" temporary; var TempItemChargeAssgntPurch: Record "Item Charge Assignment (Purch)" temporary)
//     begin
...
//     local procedure RecreateItemChargeAssgntPurch(var TempItemChargeAssgntPurch: Record "Item Charge Assignment (Purch)" temporary; var TempPurchLine: Record "Req. Line" temporary; var TempInteger: Record "Integer" temporary)
//     var
//         ItemChargeAssgntPurch: Record "Item Charge Assignment (Purch)";
//     begin
//         ClearItemAssgntPurchFilter(TempItemChargeAssgntPurch);
...
//     local procedure TransferSavedFields(var DestinationPurchaseLine: Record "Req. Line"; var SourcePurchaseLine: Record "Req. Line")
//     begin
...
//     local procedure TransferSavedJobFields(var DestinationPurchaseLine: Record "Req. Line"; SourcePurchaseLine: Record "Req. Line")
//     var
//         IsHandled: Boolean;
//     begin
//         IsHandled := false;
...
//     local procedure TransferSavedFieldsDropShipment(var DestinationPurchaseLine: Record "Req. Line"; var SourcePurchaseLine: Record "Req. Line")
//     var
...
//     local procedure TransferSavedFieldsSpecialOrder(var DestinationPurchaseLine: Record "Req. Line"; var SourcePurchaseLine: Record "Req. Line")
//     var
//         SalesLine: Record "Sales Line";
//         CopyDocMgt: Codeunit "Copy Document Mgt.";
//         IsHandled: Boolean;
...
//         "Field": Record "Field";
//     begin
//         Field.SetRange(TableNo, DATABASE::"Req. Header");
...
//         if not Field.Get(DATABASE::"Req. Header", ChangedFieldNo) then
//             Field.Get(DATABASE::"Req. Line", ChangedFieldNo);
...
//                 DATABASE::"Req. Line", "Document Type".AsInteger(), "No.", GetHideValidationDialog);
//             repeat
...
//     local procedure CheckReceiptInfo(var PurchLine: Record "Req. Line"; PayTo: Boolean)
//     begin
//         if "Document Type" = "Document Type"::Order then
//             PurchLine.SetFilter("Quantity Received", '<>0')
//         else
...
//     local procedure CheckPrepmtInfo(var PurchLine: Record "Req. Line")
//     begin
//         if "Document Type" = "Document Type"::Order then begin
...
//     local procedure CheckReturnInfo(var PurchLine: Record "Req. Line"; PayTo: Boolean)
//     begin
...
//     local procedure CheckShipToCodeChange(PurchHeader: Record "Req. Header")
//     var
//         IsHandled: Boolean;
//     begin
//         IsHandled := false;
...
//     var
//         IncomingDocument: Record "Incoming Document";
//         PurchaseLine: Record "Req. Line";
//         TempTotalPurchaseLine: Record "Req. Line" temporary;
...
//     var
//         PurchaseLine: Record "Req. Line";
//         TempPurchaseLine: Record "Req. Line" temporary;
//     begin
//         PurchaseLine.SetRange("Document Type", "Document Type");
//         PurchaseLine.SetRange("Document No.", "No.");
...
//     local procedure CollectParamsInBufferForCreateDimSet(var TempPurchaseLine: Record "Req. Line" temporary; PurchaseLine: Record "Req. Line")
//     var
...
//     local procedure InsertTempPurchaseLineInBuffer(var TempPurchaseLine: Record "Req. Line" temporary; PurchaseLine: Record "Req. Line"; AccountNo: Code[20]; DefaultDimenstionsNotExist: Boolean)
//     begin
...
//     procedure InitFromPurchHeader(SourcePurchHeader: Record "Req. Header")
//     begin
...
//     procedure OnAfterValidateBuyFromVendorNo(var PurchaseHeader: Record "Req. Header"; var xPurchaseHeader: Record "Req. Header")
//     begin
...
//     var
//         PurchaseHeaderOriginal: Record "Req. Header";
//         ReceiveFilter: Text;
//         IsMarked: Boolean;
...
//     local procedure IsShipToAddressEqualToCompanyShipToAddress(PurchaseHeader: Record "Req. Header"; CompanyInformation: Record "Company Information"): Boolean
//     begin
//         exit(
...
//     procedure ValidatePurchaserOnPurchHeader(PurchaseHeader2: Record "Req. Header"; IsTransaction: Boolean; IsPostAction: Boolean)
//     begin
...
//     var
//         CurrentPurchLine: Record "Req. Line";
//         Item: Record Item;
...
//     var
//         xRecPurchaseHeader: Record "Req. Header";
//     begin
...
//     local procedure RecreateTempPurchLines(var TempPurchLine: Record "Req. Line")
//     begin
//         repeat
...
//     local procedure DeletePurchLines(var PurchLine: Record "Req. Line")
//     var
//         IsHandled: Boolean;
//     begin
//         IsHandled := false;
