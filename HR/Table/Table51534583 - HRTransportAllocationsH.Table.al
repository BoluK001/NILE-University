table 51534583 "HR Transport Allocations H"
{
    ...
    fields
    {
        ...
        {
            TableRelation = "HR Drivers" WHERE(Active = CONST(true));
        ...
        field(64; "Responsibility Center"; Code[20])
        {
            Caption = 'Responsibility Center';
            TableRelation = "HR Entitlement Lines"."Application No.";
