table 51534573 "HR Leave Types"
{
    ...
    fields
    {
        ...
        field(17; Recurring; Boolean)
        {
        }
        field(18; Exam; Boolean)
        {
        }
        field(19; Sick; Boolean)
        {
        }
        field(20; Exception; Boolean)
        {
        }
        field(21; Compassionate; Boolean)
        {
        }
        field(22; "Mat/Pat"; Boolean)
        {
        }
        field(23; Maternity; Boolean)
        {
        }
    }
