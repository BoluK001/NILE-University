table 51534603 "HR Shortlisted Applicants"
{
    ...
    fields
    {
        ...
        field(17; "Shortlist Type"; Option)
        {
            OptionMembers = "Application Stage","Interview Stage","Test Stage";
        }
        field(18; "Interview No."; Code[20])
        {
            TableRelation = "Hr Interview Evaluation";
        }
    ...
    keys
    {
        key(Key1; "Employee Requisition No", "Shortlist Type", "Entry No.")
        {
            Clustered = true;
        }
    }
