table 51534512 "prTransaction Codes"
{
    ...
    fields
    {
        ...
        {
            OptionCaption = ' ,Housing,Transport,Other Allowances,NHF,Pension,Company Loan,Housing Deduction,Personal Loan,Dressing,Bonus Special,Other Deductions,Overtime,Entertainment,Leave,Utility,Other Co-deductions,WHT,GSM Subsidy,Co-op,Lunch,Inconvinience';
            OptionMembers = " ",Housing,Transport,"Other Allowances",NHF,Pension,"Company Loan","Housing Deduction","Personal Loan",Dressing,"Bonus Special","Other Deductions",Overtime,Entertainment,Leave,Utility,"Other Co-deductions",WHT,"GSM Subsidy","Co-op",Lunch,Inconvinience;
        }
        ...
        field(247; "Exclude from Monthly Gross"; Boolean)
        {
        }
        field(248; "Extra Payee"; Boolean)
        {
        }
        field(249; "Allowance Incetive Formula"; Boolean)
        {
        }
    }
