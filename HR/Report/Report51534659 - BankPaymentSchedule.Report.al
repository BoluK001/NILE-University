report 51534659 "Bank Payment Schedule"
{
    DefaultLayout = RDLC;
    RDLCLayout = './BankPaymentSchedule.rdlc';

    dataset
    {
        dataitem("HR-Employee"; "HR-Employee")
        {
            DataItemTableView = WHERE("Employee Classification" = CONST('PERM'));
            RequestFilterFields = "Current Month Filter", "Location/Division Code", "Department Code", "Cost Center Code", "Salary Grade", "Salary Notch/Step", "Employee Classification";
            ...
            begin
                "HR-Employee".CalcFields("HR-Employee"."Net Pay", "HR-Employee"."Special Allowance");
                ...
                PeriodTrans.Reset;
                PeriodTrans.SetFilter(PeriodTrans."Employee Code", "HR-Employee"."No.");
                PeriodTrans.SetFilter(PeriodTrans."Transaction Code", 'NPAY');
                PeriodTrans.SetFilter(PeriodTrans."Payroll Period", "HR-Employee".GetFilter("HR-Employee"."Current Month Filter"));
                if PeriodTrans.FindFirst then begin
                    NetPay := PeriodTrans.Amount;
                end;
                //NetPay:="HR-Employee"."Net Pay";  //-"HR-Employee"."Special Allowance";
