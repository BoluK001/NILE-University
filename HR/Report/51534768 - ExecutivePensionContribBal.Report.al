report 51534768 "Executive Pension Contrib Bal"
{
    DefaultLayout = RDLC;
    RDLCLayout = './ExecutivePensionContribBal.rdlc';

    dataset
    {
        dataitem("prSalary Card"; "prSalary Card")
        {
            DataItemTableView = WHERE("Salary Grade" = FILTER('LEVEL 1' | 'LEVEL 2' | 'LEVEL 3'));
