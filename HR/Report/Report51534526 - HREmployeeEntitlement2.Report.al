report 51534526 "HR Employee Entitlement2"
{
    DefaultLayout = RDLC;
    RDLCLayout = './HREmployeeEntitlement2.rdlc';
    ...
    dataset
    {
        dataitem("HR Employee Exit Interviews"; "HR Employee Exit Interviews")
        {
            ...
            dataitem(AnnualPay; "prEmployee Transactions")
            {
                ...
                begin
                    ...
                    if TransCode.Get(AnnualPay."Transaction Code") then begin
                        AnnualAmount := FnCheckSalGrade(AnnualPay."Employee Code", PrevMonth, TransCode.Formula, TransCode."Transaction Code", "HR Employee Exit Interviews"."Date Of Leaving");
                    ...
                    if TransCode.Get(AnnualPay."Transaction Code") then begin
                        if TransCode."Leave Allowance" then begin
                            if ("HR Employee Exit Interviews"."Leave Allowance Paid") or (TransCode.Passage) then
                                AnnualAmount := 0;
                        end;
                    end;
                end;
            ...
            begin
                ...
                objPeriod.SETRANGE(objPeriod."Date Opened",DMY2DATE(1,DATE2DMY("HR Employee Exit Interviews"."Date Of Leaving",2),DATE2DMY("HR Employee Exit Interviews"."Date Of Leaving",3)));
                IF objPeriod.FINDFIRST THEN BEGIN
                  NoOfMonthDays:=objPeriod."Total Working Days";
                END;
                */

                //RemainingDays:=(CALCDATE('-1D',CALCDATE('1M',DMY2DATE(1,DATE2DMY("HR Employee Exit Interviews"."Date Of Leaving",2),DATE2DMY("HR Employee Exit Interviews"."Date Of Leaving",3))))
                // -"HR Employee Exit Interviews"."Date Of Leaving");
                //TDate:=DATE2DMY"HR Employee Exit Interviews"."Date Of Leaving";
                ...
                NoticePeriod := "HR Employee Exit Interviews"."Notice Period";
                NoticePeriodServed := "HR Employee Exit Interviews"."Notice Period Served";
                ...
                prPeriodTrans.SETRANGE(prPeriodTrans."Payroll Period",CALCDATE('-1M',PrevMonth));
                ...
                */
                ...
                if "HR Employee Exit Interviews"."Pay NHF/PAYE" then begin
                    ...
                    if PeriodTrans.FindFirst then begin
                        PAYE := (PeriodTrans.Amount / NoOfMonthDays) * EmployerDedDay;
                    end;
                    ...
                    PeriodTrans.SetRange("Payroll Period", PrevMonth);
                    if PeriodTrans.FindFirst then begin
                        NHF := (PeriodTrans.Amount / NoOfMonthDays) * EmployerDedDay;
                    end;
