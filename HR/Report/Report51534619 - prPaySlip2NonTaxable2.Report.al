report 51534619 "prPaySlip2 Non Taxable2"
{
    DefaultLayout = RDLC;
    RDLCLayout = './prPaySlip2NonTaxable2.rdlc';
            ...
            dataitem("prSalary Card"; "prSalary Card")
            {
                ...
                begin
                    ...
                    *****************************************************************************************************/
                    ...
                    PeriodTrans.CalcFields(Exclude);         //dennis to filter our company deductions
                    PeriodTrans.SetRange(PeriodTrans.Exclude, true);//dennis to filter our company deductions NonTaxable
                    if PeriodTrans.Find('-') then
                        repeat
                            Gpay := StatutoryAmt + PeriodTrans.Amount;
                    ...
                    PeriodTrans.SetRange(PeriodTrans."Company Deduction", false);
                    PeriodTrans.CalcFields(Exclude);         //dennis to filter our company deductions
                    PeriodTrans.SetRange(PeriodTrans.Exclude, true);
