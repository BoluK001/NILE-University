report 51534702 "Bank Pay Schedule-SPECIAL ALLW"
{
    DefaultLayout = RDLC;
    RDLCLayout = './BankPayScheduleSPECIALALLW.rdlc';
    ...
    dataset
    {
        dataitem("HR-Employee"; "HR-Employee")
        {
            ...
            begin
                "HR-Employee".CalcFields("Special Allowance");
                ...
                GrandTotal := GrandTotal + "HR-Employee"."Special Allowance";
