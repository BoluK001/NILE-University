report 51534582 "Statutory Deductions"
{
    DefaultLayout = RDLC;
    RDLCLayout = './StatutoryDeductions.rdlc';
    ...
    dataset
    {
        dataitem("HR-Employee"; "HR-Employee")
        {
            ...
            column(FirstName_HREmployee; "HR-Employee"."First Name" + ' ' + "HR-Employee"."Middle Name" + ' ' + "HR-Employee"."Last Name")
            {
            }
            ...
            column(LocationDivisionCode_HREmployee; "HR-Employee".Office)
            {
            }
            column(Sn; Sn)
            {
            ...
            begin
                ...
                periodTrans.SetFilter(periodTrans."Transaction Code", '%1|%2', 'PAYE-CALC', 'PAYE');
