report 51534778 "PayrollSumAnalyDep NON CO"
{
    DefaultLayout = RDLC;
    RDLCLayout = './PayrollSumAnalyDepNONCO.rdlc';

    dataset
    {
        dataitem("prPeriod Transactions"; "prPeriod Transactions")
        {
            DataItemTableView = WHERE(Exclude = CONST(true), "Employee Classification" = FILTER('SNR-AS' | 'AS'));
