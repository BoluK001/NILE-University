report 51534781 "Basic Pay Listing-PERM"
{
    DefaultLayout = RDLC;
    RDLCLayout = './BasicPayListingPERM.rdlc';

    dataset
    {
        dataitem("HR-Employee"; "HR-Employee")
        {
            DataItemTableView = SORTING ("No.") WHERE (Status = CONST (Normal), "Employee Classification" = CONST ('PERM'));
