report 51534783 "Leave - Payment"
{
    DefaultLayout = RDLC;
    RDLCLayout = './LeavePayment.rdlc';

    dataset
    {
        dataitem("prPeriod Transactions"; "prPeriod Transactions")
        {
            DataItemTableView = SORTING ("Transaction Code", "Employee Code", "Payroll Period") WHERE ("Transaction Code" = FILTER ('LEAVE' | 'LEAVE2' | 'PSG' | 'PSG2'));
            RequestFilterFields = "Payroll Period";
            RequestFilterHeading = 'Leave Payment';
            ...
            column(PayrollPeriod_prPeriodTransactions; Format("prPeriod Transactions"."Payroll Period"))
            {
            }
