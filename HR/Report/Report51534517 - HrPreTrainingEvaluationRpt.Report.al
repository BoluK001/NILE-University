report 51534517 "Hr Pre Training Evaluation Rpt"
{
    DefaultLayout = RDLC;
    RDLCLayout = './HrPreTrainingEvaluationRpt.rdlc';

    dataset
    {
        dataitem("Emp Traing Eval. Questionaire"; "Emp Traing Eval. Questionaire")
        {
            DataItemTableView = WHERE("Training Evaluation Category" = CONST(Pre));
