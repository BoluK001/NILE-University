report 51534761 "Bank Pay Analysis ITADHPRNYSC"
{
    DefaultLayout = RDLC;
    RDLCLayout = './BankPayAnalysisITADHPRNYSC.rdlc';

    dataset
    {
        dataitem("HR-Employee"; "HR-Employee")
        {
            DataItemTableView = WHERE (Status = CONST (Normal), "Employee Classification" = FILTER ('ADHOC' | 'IT-INTERN' | 'PRE-NYSC'));
