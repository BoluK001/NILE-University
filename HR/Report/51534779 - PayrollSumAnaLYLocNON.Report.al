report 51534779 "Payroll Sum AnaLY - Loc NON"
{
    DefaultLayout = RDLC;
    RDLCLayout = './PayrollSumAnaLYLocNON.rdlc';

    dataset
    {
        dataitem("prPeriod Transactions"; "prPeriod Transactions")
        {
            DataItemTableView = WHERE(Exclude = CONST(true), "Employee Classification" = FILTER('PERM'));
