report 51534633 "General Journal - Test2"
{
    DefaultLayout = RDLC;
    RDLCLayout = './GeneralJournalTest2.rdlc';
    ...
    dataset
    {
        dataitem("Gen. Journal Batch"; "Gen. Journal Batch")
        {
            ...
            trigger OnAfterGetRecord()
            begin
                //Message('%1',"Gen. Journal Batch"."Journal Template Name");
            end;
            ...
            begin
                ...
                SetFilter("Gen. Journal Batch"."Journal Template Name", "Gen. Journal Line".GetFilter("Journal Template Name"));
                SetFilter("Gen. Journal Batch".Name, "Gen. Journal Line".GetFilter("Journal Batch Name"));
            end;
        }
    }
    ...
    trigger OnPreReport()
    begin
        //Message('%1',"Gen. Journal Line".GETFILTER("Journal Template Name"));
