report 51534721 "prPaySlip2 Taxable1-Self serv"
{
    DefaultLayout = RDLC;
    RDLCLayout = './prPaySlip2Taxable1Selfserv.rdlc';
            ...
            dataitem("prSalary Card"; "prSalary Card")
            {
                ...
                begin
                    ...
                    if objEmp.Find('-') then begin
                        ...
                        //GradeStep := PeriodTrans."Salary Grade" + '/' + PeriodTrans."Salary Notch";
