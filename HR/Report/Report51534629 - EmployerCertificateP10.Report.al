report 51534629 "Employer Certificate P.10"
{
    DefaultLayout = RDLC;
    RDLCLayout = './EmployerCertificateP10.rdlc';
    ...
    dataset
    {
        dataitem("prPayroll Periods"; "prPayroll Periods")
        {
            ...
            column(DataItem1102756011; taxdeduction_)
            {
            }
            ...
            column(DataItem1102756045; "DATE_Lbl")
            {
            }
            column(DataItem1102756046; SIGNATURE_Lbl)
            {
            }
            column(DataItem1102756047; ADDRESS_Lbl)
            {
            }
            column(DataItem1102756048; NAME_OF_EMPLOYER_Lbl)
            {
            }
            column(We_I_certify_that_the_particulars_entered_above_are_correctCaption; TaxDeduction_)
            {
            }
            ...
            begin
                "prPayroll Periods".CalcFields("prPayroll Periods"."Tax Paid");
                TotalTax := TotalTax + Abs("prPayroll Periods"."Tax Paid");
            end;

            trigger OnPreDataItem()
            begin
                "prPayroll Periods".SetRange("prPayroll Periods"."Date Opened", StringDate, EndDate);
        ...
        dataitem("Integer"; "Integer")
        {
            ...
            column(SIGNED_EMPLOYER______________________________________________________________________Caption; SIGNED_EMPLOYER_CaptionLbl)
            {
            }
            column(DATE_________________________________________________________________________Caption; DATE_CaptionLbl)
            {
            }
            column(OFFICIAL_USECaption; OFFICIAL_USECaptionLbl)
            {
            }
            column(DataItem1102756144; INCOME_TAX_REFERENCE_Lbl)
            {
            }
            column(DataItem1102756145; ECONOMIC_SECTOR_Lbl)
            {
            }
            column(DataItem1102756146; STATISTICAL_CODING_Lbl)
            {
            }
    ...
    var
        ...
        EmployeeLedger: Record "prPeriod Transactions";
        ...
        TaxDeduction_: Label 'We/I forward herewith.....................Tax Deduction Cards (P9A/P9B) showing the total tax deducted (as listed on P10A) amounting to  Kshs.......................';
        ...
        NAME_OF_EMPLOYER_Lbl: Label 'NAME OF EMPLOYER....................................................................................................................';
        ...
        SIGNED_EMPLOYER_CaptionLbl: Label 'SIGNED EMPLOYER......................................................................';
        DATE_CaptionLbl: Label 'DATE.........................................................................';
        OFFICIAL_USECaptionLbl: Label 'OFFICIAL USE';
        INCOME_TAX_REFERENCE_Lbl: Label 'INCOME TAX REFERENCE...........................................................................................................';
        ECONOMIC_SECTOR_Lbl: Label 'ECONOMIC SECTOR.........................................................................................................................';
        STATISTICAL_CODING_Lbl: Label 'STATISTICAL CODING.................................................................................................................';
