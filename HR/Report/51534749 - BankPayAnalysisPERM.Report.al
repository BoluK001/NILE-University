report 51534749 "Bank Pay Analysis (PERM)"
{
    DefaultLayout = RDLC;
    RDLCLayout = './BankPayAnalysisPERM.rdlc';
    ...
    dataset
    {
        dataitem("prBank Structure"; "prBank Structure")
        {
            ...
            dataitem("HR-Employee"; "HR-Employee")
            {
                ...
                DataItemTableView = WHERE (Status = CONST (Normal), "Employee Classification" = CONST ('PERM'));
