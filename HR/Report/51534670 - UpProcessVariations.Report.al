report 51534670 "Up-Process Variations"
{
    DefaultLayout = RDLC;
    RDLCLayout = './UpProcessVariations.rdlc';

    dataset
    {
        dataitem("prPayroll Variations"; "prPayroll Variations")
        {
            DataItemTableView = SORTING ("Transaction Type", "Employee Code", "Transaction Code", "Reference No", "Period Month", "Period Year", "Payroll Period") WHERE ("Payroll Period" = CONST (20121001D));
