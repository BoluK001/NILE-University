report 51534752 "prStaff Pension Contrib_CONTRA"
{
    DefaultLayout = RDLC;
    RDLCLayout = './prStaffPensionContribCONTRA.rdlc';
    ...
    dataset
    {
        dataitem("prSalary Card"; "prSalary Card")
        {
            ...
            begin
                ...
                PeriodTrans.SetRange(PeriodTrans."Employee Code", "Employee Code");
                PeriodTrans.SetRange(PeriodTrans."Payroll Period", SelectedPeriod);
                PeriodTrans.SetRange(PeriodTrans."Payroll  Classification", 'CONTRACT');
                PeriodTrans.SetRange(PeriodTrans."Company Deduction", false);  //dennis
                PeriodTrans.SetFilter(PeriodTrans."Transaction Code", '%1|%2', 'PENS', 'PENS-MATE');   //SelfContribCode
                if PeriodTrans.Find('-') then begin
                    SelfContrib := (PeriodTrans.Amount / 3 * 1);
                    CompanyContrib := (PeriodTrans.Amount / 3 * 2);
