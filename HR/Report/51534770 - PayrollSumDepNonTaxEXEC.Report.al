report 51534770 "Payroll Sum - Dep Non Tax EXEC"
{
    DefaultLayout = RDLC;
    RDLCLayout = './PayrollSumDepNonTaxEXEC.rdlc';

    dataset
    {
        dataitem("prPeriod Transactions"; "prPeriod Transactions")
        {
            DataItemTableView = WHERE (Exclude = CONST (true), "Employee Classification" = CONST ('EXEC'));
