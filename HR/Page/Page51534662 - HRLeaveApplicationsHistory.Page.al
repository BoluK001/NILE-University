page 51534662 "HR Leave Applications History"
{
    ...
    PageType = List;
    UsageCategory = Lists;
    AdditionalSearchTerms = 'HR Leave Applications History';
                ...
                action("&Send Approval Request")
                {
                    ...
                    begin
                        ...
                        if ApprovalsMgmt.CheckHRLeaveAppApprovalsWorkflowEnable(Rec) then
                            ApprovalsMgmt.OnSendHRLeaveAppForApproval(Rec);
            ...
            action("&Post Leave Application")
            {
                ...
                begin
                    ...
                    if HREmailParameters.Find('-') then begin
                        ...
                        HREmp.TestField(HREmp."Company E-Mail");
                        EmailAdd.Add(HREmailParameters.Recipients);
    ...
    begin
        ...
        if HRSetup.Find('-') then begin
            ...
            if LeaveGjline.Find('-') then begin
                ///CODEUNIT.Run(CODEUNIT::"HR Leave Jnl.-Postold", LeaveGjline); RBS
            end;
