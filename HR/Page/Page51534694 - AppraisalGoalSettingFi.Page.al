page 51534694 "Appraisal Goal Setting Fi"
{
    Caption = 'Supervisor Appraisal Review List(First)';
    ...
    PageType = List;
    UsageCategory = Lists;
    AdditionalSearchTerms = 'Supervisor Appraisal Review List(First)';
    PromotedActionCategories = 'New,Process,Report,Functions';
    SourceTable = "HR Appraisal Goal Setting H";
    SourceTableView = WHERE(Status = CONST(Review), "Appraisal Half" = CONST(First));
