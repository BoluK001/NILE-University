page 51534611 "prHeader Salary Card"
{
    ...
    layout
    {
        area(content)
        {
            group("Employee Details")
            {
                ...
                field("Payroll Posting Group"; "Payroll Posting Group") //jj121022
                {
                    Editable = false;
                    ApplicationArea = all;
                }
    ...
    actions
    {
        ...
        area(processing)
        {
            ...
            action("Process Payroll")
            {
                ...
                Promoted = true;
                PromotedCategory = Process;
                Visible = true;  //jj120422 Changed to true
                ApplicationArea = All; //jj120422 I added
