page 51534949 "Appraisal Second Half"
{
    Caption = 'Appraisal Goal Setting Second Half';
    ...
    PageType = List;
    UsageCategory = Lists;
    AdditionalSearchTerms = 'Appraisal Goal Setting Second Half';
    PromotedActionCategories = 'New,Process,Report,Functions';
    SourceTable = "HR Appraisal Goal Setting H";
    SourceTableView = WHERE("Appraisal Half" = CONST(Second));
