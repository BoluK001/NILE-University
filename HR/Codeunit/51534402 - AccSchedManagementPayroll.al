codeunit 51534402 AccSchedManagementPayroll
{
    ...
    var
        ...
        OldAccSchedLineName: Code[20];
        OldColumnLayoutName: Code[20];
    ...
    [Scope('OnPrem')]
    procedure OpenSchedule(var CurrentSchedName: Code[20]; var AccSchedLine: Record "Acc. Schedule Line")
    begin
        CheckTemplateAndSetFilter(CurrentSchedName, AccSchedLine);
    end;

    [Scope('OnPrem')]
    procedure OpenAndCheckSchedule(var CurrentSchedName: Code[20]; var AccSchedLine: Record "Acc. Schedule Line")
    var
    ...
    begin
        ...
        then
            if ConfirmManagement.GetResponse(SystemGeneratedAccSchedQst, true) then begin
    ...
    local procedure CheckTemplateAndSetFilter(var CurrentSchedName: Code[20]; var AccSchedLine: Record "Acc. Schedule Line")
    begin
    ...
    local procedure CheckTemplateName(var CurrentSchedName: Code[20])
    var
        AccSchedName: Record "Acc. Schedule Name";
    begin
    ...
    [Scope('OnPrem')]
    procedure CheckName(CurrentSchedName: Code[20])
    var
        AccSchedName: Record "Acc. Schedule Name";
    begin
    ...
    [Scope('OnPrem')]
    procedure SetName(CurrentSchedName: Code[20]; var AccSchedLine: Record "Acc. Schedule Line")
    begin
        AccSchedLine.FilterGroup(2);
        AccSchedLine.SetRange("Schedule Name", CurrentSchedName);
        AccSchedLine.FilterGroup(0);
    ...
    [Scope('OnPrem')]
    procedure LookupName(CurrentSchedName: Code[20]; var EntrdSchedName: Text[10]): Boolean
    var
        AccSchedName: Record "Acc. Schedule Name";
    begin
    ...
    [Scope('OnPrem')]
    procedure OpenColumns(var CurrentColumnName: Code[20]; var ColumnLayout: Record "Column Layout")
    begin
    ...
    local procedure CheckColumnTemplateName(var CurrentColumnName: Code[20])
    var
        ColumnLayoutName: Record "Column Layout Name";
    begin
    ...
    [Scope('OnPrem')]
    procedure CheckColumnName(CurrentColumnName: Code[20])
    var
        ColumnLayoutName: Record "Column Layout Name";
    begin
    ...
    [Scope('OnPrem')]
    procedure SetColumnName(CurrentColumnName: Code[20]; var ColumnLayout: Record "Column Layout")
    begin
        ColumnLayout.Reset;
        ColumnLayout.FilterGroup(2);
        ColumnLayout.SetRange("Column Layout Name", CurrentColumnName);
    ...
    [Scope('OnPrem')]
    procedure CopyColumnsToTemp(NewColumnName: Code[20]; var TempColumnLayout: Record "Column Layout")
    var
    ...
    [Scope('OnPrem')]
    procedure LookupColumnName(CurrentColumnName: Code[20]; var EntrdColumnName: Text[10]): Boolean
    var
        ColumnLayoutName: Record "Column Layout Name";
    begin
    ...
    [Scope('OnPrem')]
    procedure CheckAnalysisView(CurrentSchedName: Code[20]; CurrentColumnName: Code[20]; TestColumnName: Boolean)
    var
