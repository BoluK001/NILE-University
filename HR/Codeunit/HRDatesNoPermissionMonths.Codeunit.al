codeunit 51534530 "HR Dates No Permission Months"
{
    ...
    [Scope('OnPrem')]
    procedure DetermineAge(DateOfBirth: Date; DateOfJoin: Date) AgeString: Decimal
    var
        dayB: Integer;
        monthB: Integer;
        yearB: Integer;
            ...
            case (DateCat) of
                1:
                    begin
                        ...
                        AgeString := Month; //'%1  Years, %2  Months and #3## Days';
    ...
    var
        StatutoryHoliday: Record "HR Non Working Days & Dates";
        NextDay: Date;
    begin
        Holiday := 0;
        while (DateStart <= DateEnd) do begin
    ...
    [Scope('OnPrem')]
    procedure DetermineAgeYears(DateOfBirth: Date; DateOfJoin: Date) AgeString: Decimal
    var
        dayB: Integer;
        monthB: Integer;
        yearB: Integer;
            ...
            case (DateCat) of
                1:
                    begin
                        ...
                        AgeString := Year; //'%1  Years, %2  Months and #3## Days';
                                           //AgeString:= STRSUBSTNO(AgeString,Year,Month,Day);
